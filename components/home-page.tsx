...
export function HomePage() {
  return <><SiteHeader /><main id="main-content">
    <section className="new-hero">
      <div className="new-hero-copy"><p className="eyebrow">ONE COMPANY. THREE SOLUTIONS.</p><h1>Connectivity.<br />Security.<br />Access.</h1><p>Smart technology solutions for homes, businesses, apartments and properties.</p><div className="hero-action-grid"><Link className="button button-primary" href="/enquire">Start an enquiry</Link><a className="text-action" href="#services-title">Explore services <ArrowRight size={17} aria-hidden="true" /></a></div><div className="availability-note"><strong>Fibre: Juja only</strong><span>CCTV and biometric access: across Kenya</span></div></div>
