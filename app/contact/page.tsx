...
export default function ContactPage() {
  ...
  return <><SiteHeader /><main id="main-content" className="canonical-page contact-page-new">
    <section className="coverage-hero contact-coverage-hero"><p className="eyebrow">CONTACT SHENACHA</p><h1>Let’s talk about your property.</h1><p>Start one guided enquiry and we’ll route it to the right team. Fibre is currently available in Juja; CCTV and biometric access projects are considered across Kenya.</p><Link className="button button-primary" href="/enquire">Start an enquiry</Link></section>
    ...
    <section className="quote-journeys" id="request-quote"><div><p className="eyebrow">DIRECT ROUTES</p><h2>Already know what you need?</h2><p>Choose a focused path for fibre availability, a property meeting, or a security and access quote.</p></div><div><Link href="/coverage#availability-form"><span>01</span><strong>Check fibre availability</strong><small>For residents and clients in Juja</small></Link><Link href="/fibre-internet#property-meeting"><span>02</span><strong>Book a property meeting</strong><small>For Juja landlords and property teams</small></Link><Link href="/enquire"><span>03</span><strong>Request a property quote</strong><small>For CCTV or biometric access across Kenya</small></Link></div></section>
